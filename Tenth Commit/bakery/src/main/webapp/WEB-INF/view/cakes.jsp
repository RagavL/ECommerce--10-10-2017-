...
<div class="col span_1_of_3">
   ...
   <p class="ex1"><i class="fa fa-inr" aria-hidden="true"></i>${CAKES.PRICE}</p>
			 ...
			 <sec:authorize access="hasRole('Admin')">
			<a href="editcakesid/${CAKES.ID}">Edit</a>  
            <a href="deletecakes/${CAKES.ID}">Delete</a>
			</sec:authorize>
<a href="addcartbread/${CAKES.NAME}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
</div>
</c:forEach>
</div>
</div> 		
