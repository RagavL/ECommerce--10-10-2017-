...
public class UserController {
	...
	public ModelAndView sendquery(@RequestParam("Email")String em,Model m)
	{
		SimpleMailMessage semail = new SimpleMailMessage(); 
        semail.setTo(em); 
        semail.setSubject("Thank You for Query"); 
        semail.setText("Greeting from eBakery!" + "We Will get Back to you Shortly");
