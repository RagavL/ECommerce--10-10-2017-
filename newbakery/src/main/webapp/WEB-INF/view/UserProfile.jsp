...
<div class="form-group">
  ...
  <form:input path="password" type="password" placeholder="Password" class="form-control input-md "/>
  </div>
...
<div class="form-group">
  ...
  <div class="col-md-2  col-xs-4">
  <form:input path="address" type="text" placeholder="Address" class="form-control input-md "/>
  </div>
</div>
