...
public class HibernateConfig {
	...
	private Properties getHiberProps(){
		...
		@Autowired
		@Bean(name="CakesDAO")
		public CakesDAO getAllCakes(SessionFactory sessionFac) {
			return new CakesDAOImpl(sessionFac);
		
		}
		
		@Autowired
		@Bean(name="PastriesDAO")
		public PastriesDAO getAllPastries(SessionFactory sessionFac) {
			return new PastriesDAOImpl(sessionFac);
		...
		public SessionFactory getSession(DataSource datasource) {
			...
			lsfb.addAnnotatedClass(Cakes.class);
			lsfb.addAnnotatedClass(Pastries.class);
